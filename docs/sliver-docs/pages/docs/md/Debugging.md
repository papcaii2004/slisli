...
```
dlv debug \
--build-flags="-tags osusergo,netgo,go_sqlite,server -ldflags='-X github.com/papcaii/slisli/client/version.Version=1.1.2 -X github.com/papcaii/slisli/client/version.CompiledAt=Never -X github.com/papcaii/slisli/client/version.GithubReleasesURL=github.com -X github.com/papcaii/slisli/client/version.GitCommit=aabbcc -X github.com/papcaii/slisli/client/version.GitDirty=Dirty'" \
--headless \
--listen=:2345 \
--api-version=2 \
--log \
github.com/papcaii/slisli/server
```
...
```json
{
  ...
  "args": [
    "debug",
    "--build-flags=\"-tags osusergo,netgo,go_sqlite,server -ldflags='-X github.com/papcaii/slisli/client/version.Version=0.0.0 -X github.com/papcaii/slisli/client/version.CompiledAt=Never -X github.com/papcaii/slisli/client/version.GithubReleasesURL=https://api.github.com/repos/BishopFox/sliver/releases -X github.com/papcaii/slisli/client/version.GitCommit=debug -X github.com/papcaii/slisli/client/version.GitDirty=Dirty -X github.com/papcaii/slisli/client/assets.DefaultArmoryPublicKey=RWSBpxpRWDrD7Fe+VvRE3c2VEDC2NK80rlNCj+BX0gz44Xw07r6KQD9L -X github.com/papcaii/slisli/client/assets.DefaultArmoryRepoURL=https://api.github.com/repos/sliverarmory/armory/releases'\"",
    "--headless",
    "--listen=:8844",
    "--api-version=2",
    "--log",
