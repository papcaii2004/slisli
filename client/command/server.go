...
import (
	...
	"github.com/papcaii/slisli/client/command/alias"
	"github.com/papcaii/slisli/client/command/armory"
	"github.com/papcaii/slisli/client/command/beacons"
	"github.com/papcaii/slisli/client/command/builders"
	"github.com/papcaii/slisli/client/command/c2profiles"
	"github.com/papcaii/slisli/client/command/certificates"
	"github.com/papcaii/slisli/client/command/clean"
	"github.com/papcaii/slisli/client/command/crack"
	"github.com/papcaii/slisli/client/command/creds"
	"github.com/papcaii/slisli/client/command/exit"
	"github.com/papcaii/slisli/client/command/extensions"
	"github.com/papcaii/slisli/client/command/generate"
	"github.com/papcaii/slisli/client/command/hosts"
	"github.com/papcaii/slisli/client/command/info"
	"github.com/papcaii/slisli/client/command/jobs"
	"github.com/papcaii/slisli/client/command/licenses"
	"github.com/papcaii/slisli/client/command/loot"
	"github.com/papcaii/slisli/client/command/monitor"
	"github.com/papcaii/slisli/client/command/operators"
	"github.com/papcaii/slisli/client/command/reaction"
	"github.com/papcaii/slisli/client/command/sessions"
	"github.com/papcaii/slisli/client/command/settings"
	sgn "github.com/papcaii/slisli/client/command/shikata-ga-nai"
	"github.com/papcaii/slisli/client/command/socks"
	"github.com/papcaii/slisli/client/command/taskmany"
	"github.com/papcaii/slisli/client/command/update"
	"github.com/papcaii/slisli/client/command/use"
	"github.com/papcaii/slisli/client/command/websites"
	"github.com/papcaii/slisli/client/command/wireguard"
	client "github.com/papcaii/slisli/client/console"
