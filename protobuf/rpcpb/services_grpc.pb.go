...
type SliverRPCClient interface {
	...
	Screenshot(ctx context.Context, in *sliverpb.ScShotReq, opts ...grpc.CallOption) (*sliverpb.Screenshot, error)
...
func (c *sliverRPCClient) Screenshot(ctx context.Context, in *sliverpb.ScShotReq, opts ...grpc.CallOption) (*sliverpb.Screenshot, error) {
...
type SliverRPCServer interface {
	...
	Screenshot(context.Context, *sliverpb.ScShotReq) (*sliverpb.Screenshot, error)
...
func (UnimplementedSliverRPCServer) Screenshot(context.Context, *sliverpb.ScShotReq) (*sliverpb.Screenshot, error) {
...
func _SliverRPC_Screenshot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SliverRPCServer).Screenshot(ctx, req.(*sliverpb.ScShotReq))
	}
	return interceptor(ctx, in, info, handler)
}
